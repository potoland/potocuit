...
export class StringSelectMenuInteraction<T extends any[] = string[]> extends (SelectMenuInteraction as unknown as ToClass<Omit<SelectMenuInteraction, 'data'>, StringSelectMenuInteraction>) {
