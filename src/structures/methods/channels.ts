...
export interface ThreadOnlyMethods extends BaseChannel<ChannelType.GuildForum | ChannelType.GuildMedia> { }
...
export interface VoiceChannelMethods extends BaseChannel<ChannelType.GuildVoice> { }
