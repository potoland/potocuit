...
//por alguna razon si importo este archivo la clase se pone primero que el topicable
//eso hace que de error pq no puede extender una clase que se hace despues.
