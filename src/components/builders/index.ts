import { type APIButtonComponentWithCustomId, ComponentType, type TypeArray, type When } from "@biscuitland/common";
import type {
...
import {
    BaseComponent,
    ChannelSelectMenu as CSM,
    MentionableSelectMenu as MSM,
    ModalTextInput,
    RoleSelectMenu as RSM,
    StringSelectMenu as SSM,
    UserSelectMenu as USM,
} from "@biscuitland/helpers";
import type {
    ButtonInteraction,
    ...
    toJSON() {
        return {
            ...
            components: this.components.map(
                (x) => x.toJSON() as unknown as APIActionRowComponent<APITextInputComponent>,
            ),
