...
export interface ChannelRoutes {
  channels(id: string): {
    ...
    'thread-members': {
      //.
      get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIChannelThreadMembersQuery>): Promise<RESTGetAPIChannelThreadMembersResult>;
      (id: '@me'): {
        //.
      ...
      (id: string): {
        //.
        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIChannelThreadMemberQuery>): Promise<RESTGetAPIChannelThreadMemberResult>;
        //.
        put(args?: RestArguments<ProxyRequestMethod.Put>): Promise<RESTPutAPIChannelThreadMembersResult>;
        //.
        delete(args?: RestArguments<ProxyRequestMethod.Delete>): Promise<RESTDeleteAPIChannelThreadMembersResult>;
    ...
    threads: {
      //.
      post(
        args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIChannelThreadsJSONBody | RESTPostAPIGuildForumThreadsJSONBody>
    ...
    invites: {
      ...
      //.
      post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIChannelInviteJSONBody>): Promise<RESTPostAPIChannelInviteResult>;
    };
    messages: {
      //.
      get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIChannelMessagesQuery>): Promise<RESTGetAPIChannelMessagesResult>;
      //.
      post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIChannelMessageJSONBody>): Promise<RESTPostAPIChannelMessageResult>;
      'bulk-delete': {
        //.
        post(
      ...
      (id: string): {
        ...
        //.
        patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIChannelMessageJSONBody>): Promise<RESTPatchAPIChannelMessageResult>;
        //.
        ...
        reactions: {
          //.
          delete(args?: RestArguments<ProxyRequestMethod.Delete>): Promise<RESTDeleteAPIChannelAllMessageReactionsResult>;
          (emoji: string): {
            //.
            get(
