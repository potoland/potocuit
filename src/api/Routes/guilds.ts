...
export interface GuildRoutes {
  guilds: {
    ...
    templates(code: string): {
      ...
      //.
      post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPITemplateCreateGuildJSONBody>): Promise<RESTPostAPITemplateCreateGuildResult>;
    };
    (id: string): {
      //.
      ...
      channels: {
        ...
        //.
        post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIGuildChannelJSONBody>): Promise<RESTPostAPIGuildChannelResult>;
        //.
        patch(
      ...
      members: {
        //.
        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildMembersQuery>): Promise<RESTGetAPIGuildMembersResult>;
        search: {
          //.
          get(args: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildMembersSearchQuery>): Promise<RESTGetAPIGuildMembersSearchResult>;
        };
        '@me': {
          //.
          patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPICurrentGuildMemberJSONBody>): Promise<RESTGetAPIGuildMemberResult>;
        };
        (id: string): {
          //.
          get(args?: RestArguments<ProxyRequestMethod.Get>): Promise<RESTGetAPIGuildMemberResult>;
          //.
          put(args?: RestArguments<ProxyRequestMethod.Put, RESTPutAPIGuildMemberJSONBody>): Promise<RESTPutAPIGuildMemberResult>;
          //.
          //.
          patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildMemberJSONBody>): Promise<RESTPatchAPIGuildMemberResult>;
          //.
      ...
      bans: {
        ...
        (userId: string): {
          ...
          //.
          put(args?: RestArguments<ProxyRequestMethod.Put, RESTPutAPIGuildBanJSONBody>): Promise<RESTPutAPIGuildBanResult>;
          //.
      ...
      prune: {
        //.
        get(args: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildPruneCountQuery>): Promise<RESTGetAPIGuildPruneCountResult>;
        //.
        post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIGuildPruneJSONBody>): Promise<RESTPostAPIGuildPruneResult>;
      };
      regions: {
        //.
      ...
      'widget.png': {
        //.
        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildWidgetImageQuery>): Promise<RESTGetAPIGuildWidgetImageResult>;
      };
      integrations: {
        //.
      ...
      emojis: {
        ...
        //.
        post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIGuildEmojiJSONBody>): Promise<RESTPostAPIGuildEmojiResult>;
        (id: string): {
          //.
          get(args?: RestArguments<ProxyRequestMethod.Get>): Promise<RESTGetAPIGuildEmojiResult>;
          //.
          patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildEmojiJSONBody>): Promise<RESTPatchAPIGuildEmojiResult>;
          //.
      ...
      stickers: {
        ...
        //.
        post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIGuildStickerFormDataBody>): Promise<RESTPostAPIGuildStickerResult>;
        (id: string): {
          //.
          get(args?: RestArguments<ProxyRequestMethod.Get>): Promise<RESTGetAPIGuildStickerResult>;
          //.
          patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildStickerJSONBody>): Promise<RESTPatchAPIGuildStickerResult>;
          //.
      ...
      'scheduled-events': {
        //.
        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildScheduledEventsQuery>): Promise<RESTGetAPIGuildScheduledEventsResult>;
        //.
        post(
        ...
        (id: string): {
          //.
          get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPIGuildScheduledEventQuery>): Promise<RESTGetAPIGuildScheduledEventResult>;
          //.
          patch(
      ...
      templates: {
        ...
        //.
        post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPIGuildTemplatesJSONBody>): Promise<RESTPostAPIGuildTemplatesResult>;
        (code: string): {
          //.
          put(args?: RestArguments<ProxyRequestMethod.Put>): Promise<RESTPutAPIGuildTemplateSyncResult>;
          //.
          patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPIGuildTemplateJSONBody>): Promise<RESTPatchAPIGuildTemplateResult>;
          //.
