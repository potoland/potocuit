...
export interface UserRoutes {
  users: {
    ...
    (id: '@me'): {
      ...
      patch(args: RestArguments<ProxyRequestMethod.Patch, RESTPatchAPICurrentUserJSONBody>): Promise<RESTPatchAPICurrentUserResult>;
      guilds: {
        get(args?: RestArguments<ProxyRequestMethod.Get, RESTGetAPICurrentUserGuildsQuery>): Promise<RESTGetAPICurrentUserGuildsResult>;
        (id: string): {
          member: {
      ...
      channels: {
        post(args: RestArguments<ProxyRequestMethod.Post, RESTPostAPICurrentUserCreateDMChannelJSONBody>): Promise<APIDMChannel>;
      };
      connections: {
      ...
      applications(applicationId: string): {
        'role-connection': {
          get(args?: RestArguments<ProxyRequestMethod.Get>): Promise<RESTGetAPICurrentUserApplicationRoleConnectionResult>;
          put(
