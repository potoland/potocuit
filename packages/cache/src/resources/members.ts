import type { APIGuildMember, GuildMemberFlags } from '@biscuitland/common';
...
export interface PotoMember extends APIGuildMember {
	guild_id: string;
	user_id: string;
	permissions?: string;
}

// type Member = OmitAPIGuildMember, 'user'> & {
// 	user_id: string;
// }
