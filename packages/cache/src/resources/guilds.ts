import type {
	DefaultMessageNotificationLevels, DiscordGuild,
	DiscordWelcomeScreen, ExplicitContentFilterLevels,
	GuildFeatures, GuildNsfwLevel,
	MfaLevels, PremiumTiers,
	SystemChannelFlags, VerificationLevels,
...
export class Guild implements PotoGuild {
	...
	constructor(guild: PotoGuild, cache: Cache) {
